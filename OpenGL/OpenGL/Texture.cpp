...
/* Constructor. Please provide a file path to a diffuse texture */
Texture::Texture(char const * diffusePath)
{
	addDiffuse(diffusePath);
	num_textures++;
}
